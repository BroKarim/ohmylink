      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={400}>
          <AreaChart data={data}>
            ...
            <Area type="monotone" dataKey="clicks" name={showMultipleLines ? "Pageviews" : undefined} stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.6} />
            {showMultipleLines && (
              <>
                <Area type="monotone" dataKey="sessions" name="Sessions" stroke="#10b981" fill="#10b981" fillOpacity={0.6} />
                <Area type="monotone" dataKey="visitors" name="Visitors" stroke="#8b5cf6" fill="#8b5cf6" fillOpacity={0.6} />
              </>
            )}
          </AreaChart>
        </ResponsiveContainer>
