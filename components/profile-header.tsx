    ...
    <>
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10 pointer-events-none">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <Image src="/logo.png" alt="OneURL" width={24} height={24} className="h-6 w-6" priority />
              </Link>
            </TooltipTrigger>
      ...
      <div className="absolute bottom-4 left-4 right-4 flex justify-center z-10 pointer-events-none">
        <Link href="/signup" className="pointer-events-auto">
          <Button variant="outline" className="rounded-full bg-background/80 backdrop-blur-sm border shadow-sm hover:bg-background whitespace-nowrap">
