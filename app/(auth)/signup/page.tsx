  ...
  return (
    ...
    >
      <div className="space-y-6">
        <SignInButton className="w-full bg-zinc-900 hover:bg-zinc-800 text-white border-zinc-900 shadow-sm hover:shadow-md transition-all duration-200 font-medium" size="default" variant="default" callbackURL="/auth/callback">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-background px-2 text-muted-foreground">Quick & secure signup</span>
          </div>
        </div>
